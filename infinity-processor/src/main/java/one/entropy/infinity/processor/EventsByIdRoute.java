...
public class EventsByIdRoute extends EndpointRouteBuilder {

    private final String GROUP_ID = "events-by-id";
    private final String CQL = "insert into events_by_id (id, event_group, event_type, event_timestamp, value) values (?, ?, ?, ?, ?)";
